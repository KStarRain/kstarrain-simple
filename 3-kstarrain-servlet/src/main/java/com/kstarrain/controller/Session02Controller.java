 ...
 */
public class Session02Controller extends HttpServlet {

    @Override
    public void init() throws ServletException {

        System.out.println("===============  初始化 Session02Controller  ===============");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("===============  开始执行 Session02Controller的 doGet方法 " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
        ...
        while (attributeNames.hasMoreElements()){
            ...
            System.out.println("获取 Session 属性  " + attributeName + " = " + attributeValue);
        }
    ...
    @Override
    public void destroy() {
        System.out.println("===============  销毁 Session02Controller ===============");
    }
}
