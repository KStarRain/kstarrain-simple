...
public class JSONTest {
    ...
    public void test1(){
        ...
        System.out.println(JSON.parseObject("", Student.class));
...
//        Object o = JSON.toJSON(student);
    ...
    public void test5() {
        ...
        ResultDTO<Student> resultDTO = new ResultDTO<>();
        resultDTO.setMessage("成功");
        resultDTO.setCode("1000");
        resultDTO.setData(TestDataUtils.createStudent1());
        String result = JSON.toJSONString(resultDTO);


        ResultDTO<Student> studentResultDTO = JSON.parseObject(result, new TypeReference<ResultDTO<Student>>() {});
    ...
    public void test6() {
        ...
        ResultDTO<List<Student>> resultDTO = new ResultDTO<>();
        resultDTO.setMessage("成功");
        resultDTO.setCode("1000");
        ...
        ResultDTO<List<Student>> listResultDTO = JSON.parseObject(result, new TypeReference<ResultDTO<List<Student>>>() {
        });
    ...
    public void test7() {
        ...
        repaymentOrder.setOrderNo("wdd123456");
        repaymentOrder.setStatus(RepayOrderStatusEnum.CLOSED);


        System.out.println(JSON.toJSONString(repaymentOrder));
    }
    ...
    public void test8(){
        ...
        RepaymentOrder repaymentOrder = new RepaymentOrder();
        repaymentOrder.setFilePath("E:\\test\\file\\zip\\12345.zip");
